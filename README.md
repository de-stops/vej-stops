...
This is a simple script to download all [VEJ](http://www.vej-info.de) stops as [GTFS-compatible CSV](https://developers.google.com/transit/gtfs/reference/stops-file).
